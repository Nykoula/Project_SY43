...
@Composable
fun RobeOccasionScreen(navController: NavController, sellViewModel: SellViewModel) {

    var selectedType by sellViewModel.selectedType

    Scaffold(
        topBar = {
            VintedTopBar(title = "Pour occasions", navController, true)
        }
    ) { innerPadding ->
        LazyColumn(
            modifier = Modifier
